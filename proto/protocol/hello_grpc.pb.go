...
const (
	ProductInfo_AddProduct_FullMethodName = "/hello.ProductInfo/addProduct"
	ProductInfo_GetProduct_FullMethodName = "/hello.ProductInfo/getProduct"
)
